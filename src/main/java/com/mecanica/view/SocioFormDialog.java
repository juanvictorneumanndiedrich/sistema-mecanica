...
/**
 * Dialogo modal para crear o editar un Socio. Si se abre con un socio
...
public class SocioFormDialog extends JDialog {
    ...
    public SocioFormDialog(Window propietario, Socio socioExistente) {
        super(propietario, socioExistente == null ? "Nuevo Socio" : "Editar Socio",
                ModalityType.APPLICATION_MODAL);
        this.socio = socioExistente;
        armarPantalla();
        cargarDatos();
    }
    ...
    /** Socio nuevo o editado, listo para pasar al Controller. Valido solo si isConfirmado(). */
    ...
    private void cargarDatos() {
        ...
        campoDocumento.setText(socio.getDocumento());
        campoTelefono.setText(socio.getTelefono());
        checkActivo.setSelected(socio.isActivo());
    }
